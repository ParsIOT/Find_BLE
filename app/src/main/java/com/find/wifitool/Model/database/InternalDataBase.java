package com.find.wifitool.Model.database;
...
public class InternalDataBase extends SQLiteOpenHelper {
    ...
    public void deleteRecord(Event event) {

        // get reference of the BookDB database
        SQLiteDatabase db = this.getWritableDatabase();

        // delete book
        db.delete(TABLE_NAME, COLUMN_GROUP + " = ? and " + COLUMN_NAME + " = ? and " + COLUMN_USER + " = ?"  , new String[]{String.valueOf(event.getWifiGroup()), String.valueOf(event.getWifiName()), String.valueOf(event.getWifiUser())});
        db.close();
        Log.e("From DataBase", event.toString());
    }
}

...
public class TrackFragment extends Fragment {
    ...
    String urlAdvServer = "http://192.168.2.120:8000/fa/booth/advertisementJson";
...
//            getIntXY(currLocation);
            ...
            final String loc1 = "7,-82";
            final String loc2 = "7,-38";
            final String loc3 = "0,0";
            String loc1Notif = "���� ���";
            String loc2Notif = "���� ����";
            String loc3Notif = "@string/title_activity_booth";
            String defaultNotif = "this is default";

            if (!currLocation.equals(lastLoc)) {
                lastLoc = currLocation;
                switch (currLocation) {
                    case loc1:
                        notifyThis(loc1Notif, "���� ������ ��� ����.");
                        break;
                    case loc2:
                        notifyThis(loc2Notif, "���� ������ ��� ����.");
                        break;
                    case loc3:
                        notifyThis(loc3Notif, "���� ������ ��� ����.");
                        break;
                    default:
                        notifyThis(defaultNotif, "click to open");
                }
            }
    ...
    public void getAdvertismentFromServer() {
